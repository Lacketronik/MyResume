...
function Introduction({ information }: { information: InformationProps }) {
  return (
    <div className="Introduction" style={{ padding: '3.5rem', textAlign: 'center' }}>
      ...
      <br></br>
      <Card style={{ width: '100%', borderLeft: '5px solid #0d6efd', borderRight: '5px solid #0d6efd' }} className="shadow mx-auto my-4 bg-dark text-light text-start"    >
